...
/**
 * Elements shared by every ISDS message envelope, matching the gMultipleMessageEnvelopeSub
 * group of dmBaseTypes.xsd. The recipient is addressed outside of the envelope
 * (see DTO\Recipient), therefore no dmRecipientOrgUnit* element belongs here.
 */
trait MultipleMessageEnvelopeSub
{
