...
#[Serializer\XmlRoot(namespace: 'http://isds.czechpoint.cz/v20', name: 'PickUpAsyncResponseResponse')]
#[Serializer\AccessorOrder(order: 'custom', custom: ['asyncReqType', 'asyncResponse', 'status'])]
class PickUpAsyncResponse extends DataMessageResponse
{
